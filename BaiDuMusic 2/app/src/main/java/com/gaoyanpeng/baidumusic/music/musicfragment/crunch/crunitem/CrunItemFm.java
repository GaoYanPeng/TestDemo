...
import com.gaoyanpeng.baidumusic.besa.BaseXFragment;
...
public class CrunItemFm extends BaseXFragment {
    ...
    private com.gaoyanpeng.baidumusic.tool.DividerItemDecoration mDividerItemDecoration;
    ...
    protected void initView() {
        ...
        mCollapsingToolbarLayout.getCollapsedTitleGravity();
        mRecyclerView = getFindView(R.id.fm_item_crun_ryl);
        mDividerItemDecoration = new com.gaoyanpeng.baidumusic.tool.DividerItemDecoration(getContext(), DividerItemDecoration.VERTICAL);
