...
public class PlayListXBean {
    ...
    public static class ResultBean {
        ...
        private List<InfoBean.UserinfoBean> collector;
        ...
        public List<InfoBean.UserinfoBean> getCollector() {
            return collector;
        }

        public void setCollector(List<InfoBean.UserinfoBean> collector) {
