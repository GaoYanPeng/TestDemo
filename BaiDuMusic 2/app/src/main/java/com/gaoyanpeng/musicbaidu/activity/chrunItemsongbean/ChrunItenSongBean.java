package com.gaoyanpeng.musicbaidu.activity.chrunItemsongbean;

import com.google.gson.Gson;

/**
 * Created by 高研鹏 on 2016/12/5.
 */

public class ChrunItenSongBean {

    private SonginfoBean songinfo;
    private int error_code;
    private BitrateBean bitrate;

    public static ChrunItenSongBean objectFromData(String str) {

        return new Gson().fromJson(str, ChrunItenSongBean.class);
    }
