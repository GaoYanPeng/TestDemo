package com.gaoyanpeng.musicbaidu.api;
...
public class AllApi {
     ...
     * 欢迎页
     */
    public static final String URL_Welcome = "http://baifen.music.baidu.com/api/v2/offline?from=android&product=music&version=5.9.0.0&cuid=FD91A86A9F44B1249C42381F417D4253&deviceid=MDPp0%2FbS5waqt8vKnbohvA%3D%3D&width=1080&height=1776&ad_pos_id=live_one";
    /**
     * 音乐
     */
    ...
    视频最新
     */
    public static final String URL_Music_Video = "http://tingapi.ting.baidu.com/v1/restserver/ting?from=android&version=5.9.0.0&channel=360safe&operator=3&provider=11%2C12&method=baidu.ting.mv.searchMV&format=json&order=live_one&page_num=live_one&page_size=20&query=%E5%85%A8%E9%83%A8";
    /**
     * 拼接前
     */
     ...
     * 视频最热
     */
    public static final String URL_Music_Video_Host = "http://tingapi.ting.baidu.com/v1/restserver/ting?from=android&version=5.9.0.0&channel=360safe&operator=3&provider=11%2C12&method=baidu.ting.mv.searchMV&format=json&order=0&page_num=live_one&page_size=20&query=%E5%85%A8%E9%83%A8";
    /**
     * 榜单
     */
    ...
    //榜单后
    public static  final  String URL_Music_CR_Item_H = "&format=json&offset=0&size=50&from=ios&fields=title,song_id,author,resource_type,havehigh,is_new,has_mv_mobile,album_title,ting_uid,album_id,charge,all_rate&version=5.2.live_one&from=ios&channel=appstore";
    /**
     * 动态
     */
     ...
     * 音乐页 推荐 歌手
     */
    public static  final  String URL_Music_T_Song = "http://tingapi.ting.baidu.com/v1/restserver/ting?from=android&version=5.9.0.0&channel=360safe&operator=3&method=baidu.ting.artist.getList&format=json&offset=0&limit=48&order=live_one&area=0&sex=0";
    //================广播==================================================
    /**
     * 服务里的广播
     */
     ...
     * CrunchFm里的广播
     */
    public static final String CrunchFmURL = "Url";
    /**
     * CrunItemFm里的广播  歌的ID
     */
    public static final String CrunItemID = "id";
    /**
     * MianFm里的广播用来开启 一个fragment 的
     */
